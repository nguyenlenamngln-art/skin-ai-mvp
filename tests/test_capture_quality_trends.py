...
def test_rgb_trends_exclude_noneligible_capture(tmp_path):
    ...
    base={'rgb_engine_version':'1.1','redness_area_fraction':0.01,'pigmentation_area_fraction':0.02,'texture_index_proxy':0.01,'capture_quality':'good','longitudinal_eligible':True,'capture_quality_score':95.0,'tracking_series_key':'subject-1/full-face'}
