// V1.6.0.3 — localization race + capture runtime compatibility patch
// Presentation only. Keeps generated status phrases and capture UI synchronized with the selected locale.
(function(){
  ...
  const EN_TO_VI={
    ...
    // Runtime quality notes injected after analysis.
